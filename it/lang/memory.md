...
- zone is which is responsible with memory management
- a zone can be 
	- either builtin, such as a function (stack) and object
	- or custom, developer made
...
- open questions:
	...
	- can ownership change? without copy?
		...
		- study Rust, Cyclone (https://cyclone.thelanguage.org/)
